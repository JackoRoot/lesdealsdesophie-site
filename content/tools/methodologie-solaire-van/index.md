...
<pre style="font-size:15px;line-height:1.7;font-family:'Courier New',Courier,monospace;background:#1c1e26;padding:14px 16px;border-radius:8px;color:#d5d5d6;overflow-x:auto;">Wc nécessaires = Consommation journalière (Wh/j)
...
<pre style="font-size:15px;line-height:1.7;font-family:'Courier New',Courier,monospace;background:#1c1e26;padding:14px 16px;border-radius:8px;color:#d5d5d6;overflow-x:auto;">Capacité (Ah) = Consommation (Wh/j) × Jours autonomie
                ÷ 0,80 (DoD) ÷ 12V</pre>
